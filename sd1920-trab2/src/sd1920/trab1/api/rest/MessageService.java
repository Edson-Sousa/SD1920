...
public interface MessageService {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    void forwardSendMessage(@PathParam("user") String user, @QueryParam("secret") String secret, Message message);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    void forwardDeleteSentMessage(@PathParam("user") String user, @PathParam("mid") long mid, @QueryParam("secret") String secret);
}
