...
public class UserResource implements UserService {
    ...
    public String postUser(User user) {
        ...
        EmailResponse<Void> post = localMessageClient.setupUserInfo(user.getName(), MessageResource.INTERNAL_SECRET);
    ...
    public User deleteUser(String user, String pwd) {
        ...
        EmailResponse<Void> delete = localMessageClient.deleteUserInfo(user, MessageResource.INTERNAL_SECRET);
        //Errors in local requests should never happen, but we are handling them just in case
